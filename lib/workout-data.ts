...
export const workoutPlans: WorkoutPlan[] = [
  {
    ...
    exercises: [
      ...
      { name: 'תנוחת חתול-פרה (Cat-Cow)', sets: 3, reps: '10 חזרות', notes: 'על ארבע, גב מרוכך', pregnancySafe: true },
      { name: 'תנוחת הלוחם I (מעודנת)', duration: '2 דקות לכל צד', notes: 'צעד רחב, ידיים בגובה כתפיים', pregnancySafe: true },
      { name: 'תנוחת העץ (עם תמיכה בקיר)', duration: '1 דקה לכל רגל', notes: 'יד על קיר לאיזון', pregnancySafe: true },
      { name: 'ישיבת פרפר', duration: '5 דקות', notes: 'כפות רגליים יחד, גב ישר', pregnancySafe: true },
  ...
  },
  {
    ...
    exercises: [
      ...
      { name: 'גשר (Bridge)', sets: 2, reps: '12 חזרות', notes: 'גב ישר, אגן יציב', pregnancySafe: true },
      { name: 'כיווץ רצפת אגן (Kegel)', sets: 3, reps: '15 שניות החזקה', notes: 'חיוני לכל שלבי ההריון', pregnancySafe: true },
  ...
  },
  {
    ...
    exercises: [
      ...
      { name: 'תנוחת פרפר מעמיקה', duration: '5 דקות', notes: 'פתיחת אגן, גב מורם קלות', pregnancySafe: true },
      { name: 'כריעה רחבה (Squat) עם קיר', sets: 2, reps: '5 חזרות × 30 שניות', notes: 'תמיכה בקיר', pregnancySafe: true },
      { name: 'נדנוד על ארבע – שחרור גב', duration: '5 דקות', notes: 'הרפיית גב תחתון ובטן', pregnancySafe: true },
  ...
  },
  {
    ...
    exercises: [
      { name: 'סקוואט עם משקל גוף', sets: 3, reps: '15 חזרות', rest: '60 שניות' },
      { name: "לאנג'ס קדמיים", sets: 3, reps: '12 לכל רגל', rest: '60 שניות' },
      { name: 'שכיבות שמיכה על הברכיים', sets: 3, reps: '10 חזרות', rest: '60 שניות' },
      ...
      { name: 'פלאנק קדמי', sets: 3, duration: '30 שניות', rest: '30 שניות' },
      { name: "גלוטי בריג' (Glute Bridge)", sets: 3, reps: '20 חזרות', rest: '45 שניות' },
  ...
  },
  {
    ...
    exercises: [
      ...
      { name: "ג'אמפינג ג'קס", sets: 4, duration: '40 שניות פעילות / 20 מנוחה' },
      { name: 'ריצת מקום גבוהה', sets: 4, duration: '40 שניות פעילות / 20 מנוחה' },
      { name: "ברפי (ללא קפיצה)", sets: 3, duration: '30 שניות' },
      { name: 'Mountain Climbers', sets: 4, duration: '40 שניות' },
      { name: 'Squat Jumps', sets: 3, reps: '15 חזרות' },
  ...
  },
  {
    ...
    exercises: [
      { name: 'סורייה נמסקרא (שמש ביקורת) ×6', duration: '10 דקות' },
      { name: 'תנוחת לוחם III', duration: '2 דקות לכל צד' },
      { name: 'תנוחת נשר', duration: '2 דקות לכל צד' },
      { name: 'כלב מסתכל למטה ×5', duration: '3 דקות' },
  ...
  },
  {
    ...
    exercises: [
      { name: 'סקוואט עם מוט', sets: 4, reps: '8-10 חזרות', rest: '90 שניות', notes: 'משקל מאתגר' },
      { name: 'לחיצת ספסל (Bench Press)', sets: 4, reps: '8-10 חזרות', rest: '90 שניות' },
      { name: 'מתח (Pull-ups)', sets: 3, reps: 'מקסימום', rest: '90 שניות' },
      { name: 'Deadlift', sets: 3, reps: '6-8 חזרות', rest: '120 שניות', notes: 'טכניקה נכונה קודמת למשקל' },
      { name: 'לחיצת כתפיים (Overhead Press)', sets: 3, reps: '10 חזרות', rest: '75 שניות' },
      { name: 'כיפוף מרפקים עם מוט', sets: 3, reps: '12 חזרות', rest: '60 שניות' },
      { name: 'Tricep Dips', sets: 3, reps: '12-15 חזרות', rest: '60 שניות' },
      { name: 'פלאנק', sets: 3, duration: '60 שניות', rest: '30 שניות' },
    ],
  },
  {
    id: 'men-cardio-1',
    ...
    exercises: [
      ...
      { name: 'ברפי', sets: 4, reps: '15 חזרות', rest: '45 שניות' },
      { name: 'Box Jumps', sets: 4, reps: '12 חזרות', rest: '60 שניות' },
      { name: 'Mountain Climbers', sets: 4, duration: '45 שניות', rest: '15 שניות' },
      { name: 'Squat Jumps', sets: 3, reps: '20 חזרות', rest: '45 שניות' },
  ...
  },
  {
    ...
    exercises: [
      ...
      { name: 'פלאנק קדמי + צדדי', sets: 3, duration: '45 שניות כל כיוון' },
  ...
  },
  {
    ...
    exercises: [
      { name: 'סורייה נמסקרא ×5', duration: '10 דקות' },
      { name: 'תנוחת לוחם II', duration: '2 דקות לכל צד' },
      { name: 'תנוחת משולש', duration: '2 דקות לכל צד' },
      { name: 'כלב מסתכל למטה', duration: '3 דקות' },
      { name: "ישיבת פרפר", duration: '3 דקות' },
