    ...
    <div className="p-4 sm:p-6 lg:p-8 max-w-2xl mx-auto">
        ...
        <div>
          ...
          <div className="flex gap-2 mt-1">
            <span className="text-xs bg-slate-100 text-slate-600 px-2 py-0.5 rounded-full">
              {profile.gender === 'female' ? 'נקבה' : 'זכר'}
            </span>
            {profile.is_pregnant && (
          ...
          <label className="flex items-center gap-3 mt-4 cursor-pointer">
            <div
              ...
              className={`w-5 h-5 rounded border-2 flex items-center justify-center transition-all ${
                form.has_gestational_diabetes ? 'bg-pink-500 border-pink-500' : 'border-slate-300'
              }`}
            >
      ...
      <div className="bg-white rounded-2xl p-5 shadow-sm border border-slate-100 mb-5">
        ...
        <div className="flex flex-wrap gap-2">
          {GOALS.filter(g => {
            if (g.value === 'healthy_pregnancy') return profile.is_pregnant
            return true
          }).map(({ value, label }) => (
            <button
              key={value}
      ...
      <div className="bg-white rounded-2xl p-5 shadow-sm border border-slate-100 mb-5">
        ...
        <textarea
          placeholder="בעיות גב, לחץ דם, כאבי ברכיים..."
      ...
      <div className="flex flex-col gap-3">
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-2 py-3.5 rounded-2xl font-medium text-sm border-2 border-red-200 text-red-500 hover:bg-red-50 transition-all"
        >
