              ...
              {form.gender === 'female' ? (
                <>
                  ...
                  <div className="space-y-4">
                    <div className="grid grid-cols-2 gap-4">
                      <button
                        onClick={() => setForm({ ...form, is_pregnant: false, pregnancy_week: '', has_gestational_diabetes: false })}
                        className={`p-5 rounded-2xl border-2 text-center transition-all ${
                          !form.is_pregnant ? 'border-emerald-500 bg-emerald-50' : 'border-slate-200 hover:border-slate-300'
                        }`}
                      >
                      ...
                      <button
                        onClick={() => setForm({ ...form, is_pregnant: true })}
                        className={`p-5 rounded-2xl border-2 text-center transition-all ${
                          form.is_pregnant ? 'border-pink-500 bg-pink-50' : 'border-slate-200 hover:border-slate-300'
                        }`}
                      >
                        <div className="text-3xl mb-2">🤰</div>
                    ...
                    {form.is_pregnant && (
                      <div className="bg-pink-50 rounded-2xl p-5 space-y-4 border border-pink-100">
                        ...
                        <label className="flex items-center gap-3 cursor-pointer">
                          <div
                            onClick={() => setForm({ ...form, has_gestational_diabetes: !form.has_gestational_diabetes })}
                            className={`w-6 h-6 rounded-md border-2 flex items-center justify-center transition-all flex-shrink-0 ${
                              form.has_gestational_diabetes
                ...
                <>
                  ...
                  <textarea
                    placeholder="לדוגמה: בעיות גב, לחץ דם גבוה, כאבי ברכיים..."
